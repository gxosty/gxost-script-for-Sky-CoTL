...
maps = {
	...
	{"Abyss Area End", "Dusk_TriangleEnd", 0}, -- Its need, Anti Crash script. this Msg is for Gxost
...
offsets = {
	...
	swim = 0x45C22C + 0x24, -- wing_charge + 0x24, in GG = Byte include 36 Address under. for SkyShot, Dec 36 = Hex 24
	sleeping = 0x460890, --
	pose = 0x45A428, --
...
function fps60()
	...
	gg.searchNumber("1,149,698,048D;20.0~60.0F;0D::16", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 1)
	gg.refineNumber("20.0~60.0", gg.TYPE_FLOAT)
	gg.getResults(100,000)
	gg.editAll("60.0", gg.TYPE_FLOAT)
	gg.clearResults()
end
