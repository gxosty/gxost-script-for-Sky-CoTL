...
--	{'Manual', input},
	...
	{"👗️Cat Cape", 583315364},
	{"🤡Cat Mask", -901640940},
	{"🧸️Cat Prop", 1436679857},
	{"🤡 Snowman Mask [Beta] Crash ⚠", 858950093},
	{"🧸️SnowCrab Prop [Beta] Crash ⚠", 1080405300},
...
posits = {
	...
	{map='Night',name='To Office',x=-1.8873927593231201,y=36.29436492919922,z=-172.75128173828125},
	...
	{map='Prairie_Cave',name='Temple oob',x=124.29488372802734,y=283.9093231201172,z=473.84130981445312},
...
gx.add_menu({
	...
	menu = {
		...
		{"[🧎‍♂️] {gx@sit}", {gx.editor.switch, {tostring(player + offsets.status).."a 2D | 2D;"1}},
