...
function tpstatues()
	...
	for k, v in pairs(estatues) do
		table.insert(_values, {address = offset + v.x, value = pcoords.x, flags = gg.TYPE_FLOAT})
		table.insert(_values, {address = offset + v.y, value = pcoords.y, flags = gg.TYPE_FLOAT})
		table.insert(_values, {address = offset + v.z, value = pcoords.z, flags = gg.TYPE_FLOAT})
	end
